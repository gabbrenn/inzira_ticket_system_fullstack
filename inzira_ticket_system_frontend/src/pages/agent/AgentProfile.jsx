...
import { Save, User, Mail, Phone, Building2, Users } from 'lucide-react'
...
const AgentProfile = () => {
  ...
  const handleUpdateProfile = async (e) => {
    ...
    try {
      setUpdating(true)
      const response = await agentAPI.updateProfile(user.roleEntityId, profileForm)
                  ...
                  <div className="text-center">
                    ...
                    <div className="mt-2">
                      <span className={`px-2 py-1 text-xs font-medium rounded-full ${
                        profile?.confirmedByAgency 
                          ? 'bg-green-100 text-green-800' 
                          : 'bg-yellow-100 text-yellow-800'
                      }`}>
                        {profile?.confirmedByAgency ? 'Confirmed by Agency' : 'Pending Confirmation'}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="lg:col-span-1 space-y-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Email cannot be changed. Contact your branch manager if needed.
                  </p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="font-medium text-gray-900">{profile.branchOffice.officeName}</p>
                  <p className="text-sm text-gray-500">{profile.branchOffice.address}</p>
                </div>
              </div>
              <div className="flex items-center">
