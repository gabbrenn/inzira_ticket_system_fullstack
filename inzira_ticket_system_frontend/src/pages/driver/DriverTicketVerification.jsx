...
import { QrCode, Search, CheckCircle, XCircle, AlertTriangle, User, Phone, MapPin, Calendar, Clock } from 'lucide-react'
    ...
    <div className="px-4 sm:px-6 lg:px-8 fade-in">
                ...
                <form onSubmit={handleVerifyByQR} className="space-y-4">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Use your phone's camera to scan the QR code and paste the data here
                    </p>
                  </div>
                  <div className="flex space-x-3">
                    <button
      ...
      <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-blue-800">
          <div>
            <h4 className="font-medium mb-2">Booking Reference Method:</h4>
            <ul className="space-y-1">
              <li>• Ask passenger for their booking reference</li>
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li>• Use your phone to scan the QR code on the ticket</li>
              <li>• Copy and paste the QR data into the text area</li>
              <li>• Click "Verify QR Code" to validate</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-4 p-3 bg-blue-100 rounded-lg">
          <p className="text-sm text-blue-900">
            ...
            Each ticket can only be verified once.
          </p>
        </div>
      </div>
