...
const BranchManagerScheduleManagement = () => {
  ...
  const fetchAgencyRoutes = async () => {
    try {
      // Get branch manager info first to get agency ID
      const branchManagerResponse = await branchManagerAPI.getBranchManager(user.roleEntityId)
      const agencyId = branchManagerResponse.data.data.agency.id
      
      const response = await branchManagerAPI.getAgencyRoutesByAgency(agencyId)
  ...
  const fetchBuses = async () => {
    try {
      ...
      const response = await branchManagerAPI.getBusesByAgency(agencyId)
  ...
  const fetchDrivers = async () => {
    try {
      ...
      const response = await branchManagerAPI.getDriversByAgency(agencyId)
  ...
  const handleCreateSchedule = async (e) => {
    e.preventDefault()
    try {
      await branchManagerAPI.createSchedule(scheduleForm)
  ...
  const handleUpdateSchedule = async (e) => {
    e.preventDefault()
    try {
      await branchManagerAPI.updateSchedule(editingSchedule.id, scheduleForm)
  ...
  const handleCancelSchedule = async (id) => {
    if (window.confirm('Are you sure you want to cancel this schedule?')) {
      try {
        await branchManagerAPI.cancelSchedule(id)
  ...
  const handleDeleteSchedule = async (id) => {
    if (window.confirm('Are you sure you want to delete this schedule?')) {
      try {
        await branchManagerAPI.deleteSchedule(id)
    ...
    <div className="px-4 sm:px-6 lg:px-8 fade-in">
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600">
          Create and manage bus schedules for your agency
        </p>
      </div>
...
export default BranchManagerScheduleManagement